...
def instagram__connexion(driver) -> list[str]:
...
def instagram__scrapping(driver, feedName) -> list[str]:
    try : 
...
def instagram__feedSearch(driver, feedName): 
    ...
    try :
        ...
        time.sleep(10)
        driver.find_element(By.XPATH, "//*[name()='svg' and @aria-label='Découvrir']").click()     
        time.sleep(10)
